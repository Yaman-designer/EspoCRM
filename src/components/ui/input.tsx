  ...
  return (
    <input
      ...
      className={cn(
        ...
        // Final polish pass: was hover:border-border/90 — a hover state
        // that existed but read as nearly indistinguishable from rest.
        // Full-opacity border reads as a clear, confident "this is
        // interactive" signal instead of a barely-there shift.
